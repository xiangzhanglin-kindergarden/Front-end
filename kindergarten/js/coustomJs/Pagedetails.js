...
$(function(){
	$(".if-d-page-status input[name='edit2']").bind("click",function(){
		...
		$(".if-d-page-status input[name='edit2']").addClass("dtu2");
		setTimeout(function(){
			$(".if-d-page-status input[name='edit2']").css({
				'margin-top':"-70px"
			})
			$(".if-d-p-s-e-btn").css({
				'margin-top':"-8px"
		...
		setTimeout(function(){
			...
			$(".if-d-page-status input[name='edit2']").removeClass("dtu2");
		},1001)
	...
	$(".if-d-no").bind("click",function(){
		...
		setTimeout(function(){
			...
			$(".if-d-page-status input[name='edit2']").removeClass("utd2");
		},1001)
